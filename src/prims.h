...
enum {
    ...
    /* sound */
    P_BEEP, P_QUIET, P_SOUNDING, P_VOLUME, P_DOTPAREN, P_AGAINBR, P_FINDNAME, P_CONSTEP, P_BYE, P_INCLUDED, P_FILES, P_LATESTAT, P_LATESTST, P_EDITOPEN, P_EDITOR, P_EDITED
};
